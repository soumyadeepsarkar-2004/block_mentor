...
const Tutors = () => {
    ...
    const handleSearch = (e: React.FormEvent) => {
        ...
        const filtered = tutorsData.filter(
            (tutor) => tutor.name.toLowerCase().includes(searchTerm.toLowerCase()) || tutor.title.toLowerCase().includes(searchTerm.toLowerCase()) || tutor.specialties.some((specialty) => specialty.toLowerCase().includes(searchTerm.toLowerCase()))
        );
                ...
                <section className="py-12 px-6 md:py-16 md:px-12 max-w-7xl mx-auto">
                    ...
                    <div className="mb-10">
                        <form onSubmit={handleSearch} className="flex gap-2 max-w-xl mx-auto mb-6">
                            <div className="relative flex-grow">
                                ...
                                <Input type="text" placeholder="Search by name, specialty, or topic..." className="pl-10" value={searchTerm} onChange={(e) => setSearchTerm(e.target.value)} />
                            </div>
                    ...
                    <Tabs defaultValue="all" className="mb-10">
                        ...
                        <TabsContent value="smart-contracts" className="mt-6">
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                                {filteredTutors.filter((tutor) => tutor.specialties.includes("Smart Contracts")).map((tutor) => (
                                    <Card key={tutor.id} className="overflow-hidden glass-card hover:shadow-lg transition-shadow duration-300">
                                        <div className="p-6">
                                            <div className="flex items-center gap-4 mb-4">
                                                <Avatar className="h-12 w-12 border-2 border-primary/20">
