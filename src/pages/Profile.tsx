...
import { UserCog, Save, Camera, ArrowLeft, Wallet, Plus, Trash2, MapPin, Phone, } from "lucide-react";
...
const Profile = () => {
    ...
    const handleToggleChange = (
        ...
        setFormData((prev) => ({
            ...prev, preferences: { ...prev.preferences, [key]: !prev.preferences[key], },
        }));
    };
    ...
    const handleAddWallet = () => {
        ...
        setFormData((prev) => ({
            ...prev, wallets: [...prev.wallets, {
                address: newWallet.address, label: newWallet.label,
    ...
    const handleDeleteWallet = (index: number) => {
        ...
        setFormData((prev) => ({
            ...prev, wallets: prev.wallets.filter((_, i) => i !== index),
        }));
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        ...
                        <Card className="glass-card md:col-span-2">
                            <CardHeader>
                                ...
                                <CardDescription>
                                    {isEditing ? "Update your personal information and preferences" : "Your personal information and account settings"}
                                </CardDescription>
                            </CardHeader>
                            <CardContent>
                                                        ...
                                                        <div key={index} className="bg-muted/40 rounded-lg p-4 relative">
                                                            <div className="flex items-center gap-3 mb-2">
                                                                ...
                                                                {isEditing && formData.wallets.length > 1 && (
                                                                    <Button variant="ghost" size="icon" className="absolute right-2 top-2 h-8 w-8 text-destructive hover:text-destructive/90" onClick={() => handleDeleteWallet(index)}>
                                                ...
                                                <div className="bg-muted/20 rounded-lg p-4 border border-dashed border-muted-foreground/50">
                                                    ...
                                                    <div className="space-y-4">
                                                        <div className="space-y-2">
                                                            ...
                                                            <Input id="walletLabel" name="label" placeholder="e.g., Hardware Wallet" value={newWallet.label} onChange={handleNewWalletChange} />
                                                        </div>
                                                        <div className="space-y-2">
                                                            <Label htmlFor="walletAddress">
                                                                Wallet Address
                                                            </Label>
                                                            <Input id="walletAddress" name="address" placeholder="0x..." value={newWallet.address} onChange={handleNewWalletChange} />
                                                        </div>
                                        ...
                                        <div className="space-y-4">
                                            <div className="flex items-center justify-between">
                                                ...
                                                <div className="flex items-center space-x-2">
                                                    {isEditing ? (
                                                        <input type="checkbox" checked={formData.preferences.notifications} onChange={() => handleToggleChange("notifications")} className="cursor-pointer h-4 w-4" />
                                                    ) : (
                                                        <span>
                                            ...
                                            <div className="flex items-center justify-between">
                                                ...
                                                <div className="flex items-center space-x-2">
                                                    {isEditing ? (
                                                        <input type="checkbox" checked={formData.preferences.twoFactorAuth} onChange={() => handleToggleChange("twoFactorAuth")} className="cursor-pointer h-4 w-4" />
                                                    ) : (
                                                        <span>
                                            ...
                                            <div className="flex items-center justify-between">
                                                ...
                                                <div className="flex items-center space-x-2">
                                                    {isEditing ? (
                                                        <input type="checkbox" checked={formData.preferences.publicProfile} onChange={() => handleToggleChange("publicProfile")} className="cursor-pointer h-4 w-4" />
                                                    ) : (
                                                        <span>
                                                            {profile.preferences.publicProfile ? "Enabled" : "Disabled"}
                                                        </span>
                                                    )}
                                                </div>
                                            </div>
