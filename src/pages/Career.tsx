...
import { MapPin, Clock, DollarSign, ArrowRight, Building, BookOpen, Users, } from "lucide-react";
...
const jobListings = [
    {
        ...
        posted: "3 days ago",
        description: "Develop and implement smart contracts and decentralized applications on Ethereum and other blockchain platforms.",
    ...
    },
    {
        ...
        posted: "1 week ago",
        description: "Teach blockchain fundamentals and cryptocurrency concepts to students in a virtual classroom environment.",
        skills: [
            "Teaching",
    ...
    },
    {
        ...
        salary: "Competitive",
        posted: "2 days ago",
        description: "Perform security audits on smart contracts to identify vulnerabilities and ensure code quality and safety.",
    ...
    },
    {
        ...
        posted: "4 days ago",
        description: "Consult with enterprises on blockchain implementation strategies and solutions.",
        skills: [
            "Consulting",
    ...
    },
    {
        ...
        posted: "1 week ago",
        description: "Research and analyze cryptocurrency projects, market trends, and blockchain technologies.",
    ...
    },
    {
        ...
        posted: "5 days ago",
        description: "Build and manage online communities for blockchain projects, create content, and drive engagement.",
        skills: [
...
const careerResources = [
    {
        ...
        description: "Our comprehensive guide to starting your career in blockchain technology.",
        link: "/courses?category=career",
        icon: <BookOpen className="h-10 w-10 text-tutor-blue" />,
    },
    {
        title: "Industry Networking Events",
        description: "Join virtual and in-person events to connect with blockchain professionals.",
        link: "/events",
    ...
    return (
        <div className="min-h-screen flex flex-col">
            ...
            <main className="flex-grow">
                    ...
                    <div className="max-w-4xl mx-auto text-center">
                        ...
                        <div className="glass-card p-8 md:p-10">
                            <p className="text-lg md:text-xl leading-relaxed mb-6">
                                The blockchain industry is growing rapidly, creating new opportunities for professionals with the right skills and knowledge. Explore career paths, listings, and resources to help you succeed in this innovative field.
                            </p>
                            <div className="flex flex-wrap justify-center gap-4">
                                <Button size="lg" className="bg-tutor-blue hover:bg-tutor-blue-dark">
                    ...
                    <div className="max-w-6xl mx-auto">
                        <div className="text-center mb-16">
                            ...
                            <p className="max-w-2xl mx-auto text-tutor-neutral-dark">
                                The blockchain ecosystem offers diverse career opportunities across multiple disciplines. Explore the paths that match your skills and interests.
                            </p>
                        </div>
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
                            <Card className="glass-card">
                                <CardContent className="p-6">
                                    ...
                                    <p className="text-tutor-neutral-dark mb-4">
                                        Build the infrastructure and applications that power the decentralized web as a blockchain developer, smart contract engineer, or dApp developer.
                                    </p>
                            ...
                            <Card className="glass-card">
                                <CardContent className="p-6">
                                    ...
                                    <p className="text-tutor-neutral-dark mb-4">
                                        Help organizations implement blockchain solutions as a consultant, product manager, or business development professional.
                                    </p>
                                    <ul className="space-y-2 mb-4">
                                        <li className="flex items-center gap-2 text-sm text-tutor-neutral-dark">
                                            <span className="w-1 h-1 rounded-full bg-tutor-blue"></span>
                            ...
                            <Card className="glass-card">
                                <CardContent className="p-6">
                                    ...
                                    <p className="text-tutor-neutral-dark mb-4">
                                        Advance blockchain knowledge and adoption as an educator, researcher, or community builder.
                                    </p>
                                    <ul className="space-y-2 mb-4">
                                        <li className="flex items-center gap-2 text-sm text-tutor-neutral-dark">
                                            <span className="w-1 h-1 rounded-full bg-tutor-blue"></span>
                ...
                <section id="job-listings" className="py-20 px-6 bg-gradient-to-b from-white to-tutor-neutral">
                    <div className="max-w-6xl mx-auto">
                        <div className="text-center mb-16">
                            <span className="px-3 py-1 text-sm font-medium bg-tutor-blue/10 text-tutor-blue rounded-full">
                                Job Board
                            ...
                            <p className="max-w-2xl mx-auto text-tutor-neutral-dark">
                                Browse our curated list of blockchain job opportunities from leading companies in the space.
                            </p>
                        </div>
                        <Tabs defaultValue="all" className="mb-8">
                                                ...
                                                <div className="mb-4">
                                                    ...
                                                    <div className="flex flex-wrap gap-2">
                                                        {job.skills.map((skill, index) => (
                                                            <Badge key={index} variant="outline" className="bg-tutor-neutral/30">
                                                                {skill}
                                                            </Badge>
                                                        ))}
                                                    </div>
                            ...
                            {[
                                ...
                                <TabsContent key={category} value={category} className="mt-6">
                                    <div className="space-y-6">
                                        {jobListings.filter((job) => job.category === category).map((job) => (
                                            <Card key={job.id} className="glass-card overflow-hidden">
                                                <CardContent className="p-6">
                                                    <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-4">
                                                        <h3 className="text-xl font-bold text-tutor-neutral-darker mb-2 md:mb-0">
                                    ...
                                    {jobListings.filter((job) => job.category === category).length === 0 && (
                                        <div className="text-center py-12">
                                            <h3 className="text-xl font-medium mb-2 text-tutor-neutral-darker">
                                                No jobs found
                                            </h3>
                                            <p className="text-tutor-neutral-dark">
                                                No current openings in this category. Check back soon or browse other categories.
                                            </p>
                                        </div>
                                    )}
                                </TabsContent>
                    ...
                    <div className="max-w-6xl mx-auto">
                        ...
                        <div className="text-center">
                            ...
                            <p className="text-tutor-neutral-dark max-w-2xl mx-auto mb-8">
                                Our expert tutors can help you develop the skills you need to succeed in the blockchain industry.
                            </p>
                            <Button size="lg" className="bg-tutor-blue hover:bg-tutor-blue-dark">
