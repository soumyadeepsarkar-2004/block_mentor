          ...
          <div className="flex border-b border-white/20 mb-6">
            <button
              className={`px-4 py-2 text-sm font-medium ${activeTab === "about"
                  ? "text-tutor-blue border-b-2 border-tutor-blue"
                  : "text-tutor-neutral-dark"
                }`}
            ...
            <button
              className={`px-4 py-2 text-sm font-medium ${activeTab === "availability"
                  ? "text-tutor-blue border-b-2 border-tutor-blue"
                  : "text-tutor-neutral-dark"
                }`}
            ...
            <div className="animate-fade-in">
              ...
              <div className="space-y-6">
                <div className="border-b border-white/20 pb-6">
                  ...
                  <p className="text-sm text-tutor-neutral-dark">
                    Excellent tutor! Made complex blockchain concepts easy to
                    understand. The smart contract demos were particularly
                ...
                <div>
                  ...
                  <p className="text-sm text-tutor-neutral-dark">
                    Very knowledgeable about Ethereum development. Sessions were
                    well-structured and helped me improve my coding skills
                    significantly.
                  </p>
                </div>
              </div>
            ...
            <div className="animate-fade-in">
              ...
              <div className="mb-6">
                <div className="bg-tutor-blue/5 rounded-lg p-4 mb-4">
                  ...
                  <p className="text-sm text-tutor-neutral-dark">
                    Calendar widget would be displayed here. Sessions are
                    confirmed via smart contract with automatic reminders.
                  </p>
                </div>
              </div>
