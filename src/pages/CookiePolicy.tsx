        ...
        <div className="space-y-10">
          <section>
            ...
            <p className="text-tutor-neutral-dark mb-4">
              This Cookie Policy explains how Blockchain Tutor ("we", "us", or
          ...
          <section>
            ...
            <p className="text-tutor-neutral-dark mb-4">
              ...
              by clicking on the "Cookie Settings" link in the footer of our
              website.
            </p>
            <p className="text-tutor-neutral-dark">
          ...
          <section>
            ...
            <p className="text-tutor-neutral-dark mb-4">
              ...
              page to stay informed about our cookie practices.
            </p>
            <p className="text-tutor-neutral-dark">
