...
const coursesData: CourseProps[] = [
  {
    ...
    description:
      "Start your blockchain journey with this comprehensive introduction to decentralized technology fundamentals.",
    image:
  ...
  },
  {
    ...
    description:
      "Learn to build, test, and deploy secure smart contracts on the Ethereum blockchain using Solidity.",
    image:
  ...
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1655720828018-7461cfa2d2c0?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1932&q=80",
    duration: "10 hours",
    students: 1645,
    rating: 4.7,
    level: "Intermediate",
            ...
            <div className="mb-10">
              <div className="flex flex-col md:flex-row gap-4 mb-6">
                <div className="flex-1 relative">
                  <Search
                    className="absolute left-3 top-1/2 transform -translate-y-1/2 text-tutor-neutral-dark"
                    size={18}
                  />
                  <Input
                    type="text"
                ...
                <div className="glass-card p-4 mb-6 animate-slide-down">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {[
                      ...
                      <button
                        key={level}
                        className={`px-3 py-1 text-sm rounded-full transition-colors ${activeFilter === level
