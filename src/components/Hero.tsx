...
const Hero = () => {
    ...
    return (
        <div ref={heroRef} className="relative min-h-screen flex items-center justify-center px-6 pt-20">
            <div className="absolute inset-0 overflow-hidden">
                <div className="absolute top-1/4 right-1/4 w-96 h-96 rounded-full bg-[#0A84FF]/5 blur-3xl parallax-element" data-speed="0.03"></div>
                <div className="absolute bottom-1/3 left-1/3 w-72 h-72 rounded-full bg-[#5AC8FA]/5 blur-3xl parallax-element" data-speed="0.05"></div>
                <div className="absolute top-1/3 left-1/4 w-64 h-64 rounded-full bg-[#0A84FF]/5 blur-3xl parallax-element" data-speed="0.07"></div>
            </div>
            <div className="max-w-6xl mx-auto text-center relative z-10">
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                    ...
                    <Link to="/courses">
                        <Button variant="outline" className="font-medium px-4 py-3.5 h-auto rounded-md gap-2 border-[#1D1D1F] hover:bg-[#F5F5F7]">
                            Explore Courses
                            <ArrowRight size={16} />
                        </Button>
                    </Link>
