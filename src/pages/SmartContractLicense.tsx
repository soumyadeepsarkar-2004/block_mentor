...
import { Shield, Download, CheckCircle2, Fingerprint, AlertCircle, } from "lucide-react";
import { toast } from "sonner";
import { Card, CardContent, CardDescription, CardHeader, CardTitle, } from "@/components/ui/card";

const SmartContractLicense = () => {
    const [licenseStatus, setLicenseStatus] = useState<"inactive" | "pending" | "active">("inactive");
    ...
    const activateLicense = () => {
        ...
        setTimeout(() => {
            ...
            toast.success("License successfully activated!", {
                description: "Your educational content license is now secured on the blockchain",
            });
        }, 3000);
    };
            ...
            <div className="max-w-4xl mx-auto">
                <div className="text-center mb-8">
                    ...
                    <p className="max-w-2xl mx-auto text-tutor-neutral-dark">
                        Protect and verify your educational content with blockchain technology. Generate tamper-proof licenses that ensure your intellectual property rights.
                    </p>
                </div>
                        ...
                        {licenseStatus === "inactive" && (
                            <div className="space-y-4">
                                <Alert variant="destructive" className="bg-red-50 text-red-800 border-red-200">
                                    ...
                                    <AlertDescription>
                                        You don't have an active license for this educational content. Activate a license to access and use this material.
                                    </AlertDescription>
                                </Alert>
                                ...
                                <Button className="w-full bg-tutor-blue hover:bg-tutor-blue-dark" onClick={activateLicense}>
                                    Activate License
                                </Button>
                            </div>
                        )}
                        {licenseStatus === "pending" && (
                            <div className="flex flex-col items-center justify-center py-10">
                                ...
                                <p className="text-tutor-neutral-dark text-center max-w-sm">
                                    We're creating your blockchain-secured license. This process typically takes less than a minute.
                                </p>
                            </div>
                        )}
                        {licenseStatus === "active" && (
                            <div className="space-y-4">
                                <Alert className="bg-green-50 text-green-800 border-green-200">
                                    ...
                                    <AlertDescription>
                                        Your license has been successfully activated and secured on the blockchain.
                                    </AlertDescription>
                                </Alert>
                                <div className="p-5 border rounded-lg bg-white">
                                    <div className="flex items-center justify-between mb-4">
                                        ...
                                        <Button variant="outline" size="sm" className="flex items-center gap-1" onClick={downloadLicense}>
                                ...
                                <div className="rounded-lg bg-tutor-blue/5 p-4 border border-tutor-blue/20">
                                    ...
                                    <ol className="space-y-2 text-sm text-tutor-neutral-dark list-decimal pl-5">
                                        <li>Visit our verification portal at verify.blockchaintutor.com</li>
                                        <li>Enter the License ID or scan the QR code on the certificate</li>
                                        <li>Alternatively, check the transaction directly on Etherscan using the Transaction Hash</li>
                                    </ol>
                                </div>
                            </div>
                        )}
