        ...
        <div className="space-y-10">
          <section>
            ...
            <p className="text-tutor-neutral-dark mb-4">
              By accessing or using Blockchain Tutor's services, you agree to be
          ...
          <section>
            ...
            <p className="text-tutor-neutral-dark mb-4">
              Blockchain Tutor provides an AI-driven educational platform
              focused on blockchain technology, cryptocurrency, and related
              topics. Our services include online courses, tutoring sessions,
          ...
          <section>
            ...
            <p className="text-tutor-neutral-dark mb-4">
              ...
              of Blockchain Tutor or its licensors and is protected by copyright
          ...
          <section>
            ...
            <p className="text-tutor-neutral-dark mb-4">
              To the maximum extent permitted by law, Blockchain Tutor and its
