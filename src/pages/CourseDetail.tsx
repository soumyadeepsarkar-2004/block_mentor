...
const CourseDetail = () => {
    ...
    const completedLessons = course.modules.reduce((total, module) => { return total + module.lessons.filter((lesson) => lesson.completed).length; }, 0);
                    ...
                    <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-8 items-center">
                        <div>
                            ...
                            <div className="flex items-center gap-4 mb-6">
                                <img src={course.instructor.avatar} alt={course.instructor.name} className="w-12 h-12 rounded-full border-2 border-primary/20" />
                                <div>
                                    ...
                                    <div>
                                        ...
                                        <ul className="space-y-4">
                                            ...
                                            <li className="flex gap-3">
                                                <CheckCircle className="h-6 w-6 text-green-500 flex-shrink-0" />
                                                <span>
                                                    Build and deploy your first decentralized application </span>
                                            </li>
                                            <li className="flex gap-3">
                                                <CheckCircle className="h-6 w-6 text-green-500 flex-shrink-0" />
                                                <span>
                                                    ...
                                                    <ul>
                                                        {module.lessons.map((lesson, lessonIndex) => (
                                                            <li key={lesson.id} className={`p-4 border-b last:border-b-0 flex justify-between items-center ${lesson.completed ? "bg-green-50/50" : ""}`}>
                                                                <div className="flex items-center gap-3">
                                                                    {lesson.completed ? (<CheckCircle className="h-5 w-5 text-green-500" />) : (<div className="flex h-5 w-5 items-center justify-center rounded-full border border-muted-foreground text-xs">
                                                                ...
                                                                <Button variant="ghost" size="sm" className="ml-4" onClick={() => handlePlayLesson(lesson)}>
                                                                    {lesson.free || isConnected ? ("Play") : (<LockIcon className="h-4 w-4" />)}
                                                                </Button>
                                                            </li>
                                                        ))}
                                                    </ul>
                                    ...
                                    <div className="flex flex-col md:flex-row gap-8 items-center md:items-start">
                                        ...
                                        <div>
                                            ...
                                            <div className="space-y-4">
                                                ...
                                                <p>
                                                    With a passion for teaching complex concepts in an accessible way, {course.instructor.name} has helped thousands of students understand blockchain technology and practical applications.
                                                </p>
                                                <p>
