...
import { Calendar, MessageCircle, Star, ThumbsUp, Award, Clock, } from "lucide-react";

export interface TutorProps {
    id: string; name: string; title: string; bio: string; avatar: string; rating: number; reviews: number; students: number; hourlyRate: number; expertise: string[]; languages: string[]; availability: { days: string[]; hours: string; };
}
            ...
            <div className="flex flex-col md:flex-row">
                <div className="md:w-1/3 p-6 border-b md:border-b-0 md:border-r border-white/20">
                    <div className="flex flex-col items-center text-center">
                        ...
                        <div className="flex items-center gap-1 mb-4">
                            ...
                            <span className="text-xs text-tutor-neutral-dark">
                        ...
                        <div className="w-full mb-6">
                            ...
                            <div className="flex flex-wrap gap-2 justify-center">
                                {tutor.expertise.map((skill, index) => (
                                    <span key={index} className="inline-block px-2.5 py-1 text-xs bg-tutor-blue/10 text-tutor-blue rounded-full">
                                        {skill}
                                    </span>
                                ))}
                            </div>
                ...
                <div className="md:w-2/3 p-6">
                    <div className="flex border-b border-white/20 mb-6">
                        <button className={`px-4 py-2 text-sm font-medium ${activeTab === "about" ? "text-tutor-blue border-b-2 border-tutor-blue" : "text-tutor-neutral-dark"}`} onClick={() => setActiveTab("about")}>
                            About
                        </button>
                        <button className={`px-4 py-2 text-sm font-medium ${activeTab === "reviews" ? "text-tutor-blue border-b-2 border-tutor-blue" : "text-tutor-neutral-dark"}`} onClick={() => setActiveTab("reviews")}>
                            Reviews
                        </button>
                        <button className={`px-4 py-2 text-sm font-medium ${activeTab === "availability" ? "text-tutor-blue border-b-2 border-tutor-blue" : "text-tutor-neutral-dark"}`} onClick={() => setActiveTab("availability")}>
                            Availability
                        </button>
                    </div>
                    {activeTab === "about" && (
                                ...
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-tutor-neutral-dark">
                                            98% from {tutor.students} students
                                        </p>
                                    </div>
                                </div>
                                <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <div className="space-y-6">
                                    ...
                                    <div className="flex items-center gap-3 mb-3">
                                        ...
                                        <div>
                                            ...
                                            <div className="flex items-center gap-1">
                                                ...
                                                <Star size={12} className="text-yellow-500 fill-yellow-500" />
                                                <Star size={12} className="text-yellow-500 fill-yellow-500" />
                                                <span className="text-xs text-tutor-neutral-dark ml-1">
                                                    1 month ago
                                                </span>
                                            </div>
                                        </div>
                                ...
                                <div>
                                    <div className="flex items-center gap-3 mb-3">
                                        <div className="h-10 w-10 rounded-full overflow-hidden">
                                            <img src="https://i.pravatar.cc/150?img=44" alt="Student" className="w-full h-full object-cover" />
                                        </div>
                                        <div>
                    ...
                    {activeTab === "availability" && (
                        <div>
                            ...
                            <p className="text-tutor-neutral-dark mb-6">
                                {tutor.name} is available on{" "}
                                {tutor.availability.days.join(", ")} from{" "}
                                {tutor.availability.hours}.
                            </p>
                            <div className="mb-6">
