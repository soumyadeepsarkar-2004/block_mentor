                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                    ...
                    <div className="bg-white p-8 rounded-xl shadow-subtle">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            <div>
                                <label htmlFor="name" className="block text-sm font-medium text-tutor-neutral-darker mb-1">
                                    Your Name
                                </label>
                                <Input id="name" name="name" value={formData.name} onChange={handleChange} placeholder="John Doe" required className="w-full" />
                            </div>
                            <div>
                                <label htmlFor="email" className="block text-sm font-medium text-tutor-neutral-darker mb-1">
                                    Email Address
                                </label>
                            ...
                            <div>
                                <label htmlFor="subject" className="block text-sm font-medium text-tutor-neutral-darker mb-1">
                                    Subject
                                </label>
                            ...
                            <div>
                                <label htmlFor="message" className="block text-sm font-medium text-tutor-neutral-darker mb-1">
                                    Message
                                </label>
                                <Textarea id="message" name="message" value={formData.message} onChange={handleChange} placeholder="Your message here..." required className="w-full min-h-[150px]" />
                            </div>
                            <Button type="submit" className="w-full bg-tutor-blue hover:bg-tutor-blue-dark" disabled={isSubmitting}>
