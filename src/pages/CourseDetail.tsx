    ...
    modules: [
      {
        ...
        lessons: [
          ...
          {
            id: "l4",
            title: "Assembly and Low-Level Calls",
            duration: "35:20",
            free: false,
            completed: false,
          },
                ...
                <div className="grid md:grid-cols-2 gap-12">
                  <div>
                    ...
                    <ul className="space-y-4">
                      ...
                      <li className="flex gap-3">
                        <CheckCircle className="h-6 w-6 text-green-500 flex-shrink-0" />
                        <span>
                          Learn how cryptocurrencies work and their underlying
                          mechanisms
                        </span>
                      </li>
                      <li className="flex gap-3">
                        <CheckCircle className="h-6 w-6 text-green-500 flex-shrink-0" />
                        <span>
                          Explore smart contracts and the Ethereum Virtual
                          Machine
                        </span>
                      </li>
                      <li className="flex gap-3">
                      ...
                      <li className="flex gap-3">
                        <CheckCircle className="h-6 w-6 text-green-500 flex-shrink-0" />
                        <span>
                          Understand the security implications of blockchain
                          systems
                        </span>
                      </li>
                    </ul>
                  ...
                  <div>
                    ...
                    <div className="space-y-4 text-muted-foreground">
                      <p>
                        This comprehensive course on blockchain fundamentals
                        will take you from a complete beginner to having a solid
                        understanding of blockchain technology and its
                        applications.
                      </p>
                      <p>
                        Starting with the basic concepts of distributed ledgers
                        and consensus mechanisms, we'll progress to explore
                        cryptocurrencies, smart contracts, and decentralized
                        applications. By the end of this course, you'll have
                        built your first dApp and understand the core principles
                        that make blockchain technology revolutionary.
                      </p>
                      <p>
                        Whether you're looking to build blockchain applications,
                        invest in cryptocurrencies, or simply understand the
                        technology that's changing finance and beyond, this
                        course provides the foundation you need.
                      </p>
                    </div>
                    <h2 className="text-2xl font-semibold mt-12 mb-6">
                    ...
                    <ul className="space-y-2 text-muted-foreground">
                      <li className="flex gap-3">
                        ...
                        <span>
                          Developers interested in blockchain application
                          development
                        </span>
                      </li>
                      <li className="flex gap-3">
                      ...
                      <li className="flex gap-3">
                        <CheckCircle className="h-5 w-5 text-green-500 flex-shrink-0" />
                        <span>
                          Cryptocurrency enthusiasts who want to deepen their
                          technical knowledge
                        </span>
                      </li>
                      <li className="flex gap-3">
                        <CheckCircle className="h-5 w-5 text-green-500 flex-shrink-0" />
                        <span>
                          Students and researchers interested in decentralized
                          systems
                        </span>
                      </li>
                    </ul>
                        ...
                        <CardContent className="p-0">
                          <ul>
                            {module.lessons.map((lesson, lessonIndex) => (
                              <li
                                key={lesson.id}
                                className={`p-4 border-b last:border-b-0 flex justify-between items-center ${lesson.completed ? "bg-green-50/50" : ""
                                  }`}
                              >
                                <div className="flex items-center gap-3">
                                  {lesson.completed ? (
                  ...
                  <div className="flex flex-col md:flex-row gap-8 items-center md:items-start">
                    ...
                    <div>
                      ...
                      <div className="space-y-4">
                        ...
                        <p>
                          With a passion for teaching complex concepts in an
                          accessible way,
                          {course.instructor.name} has helped thousands of
                          students understand blockchain technology and its
                          practical applications.
                        </p>
                        <p>
                          Their teaching approach combines theoretical knowledge
                          with hands-on projects, ensuring students gain both
