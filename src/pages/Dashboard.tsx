...
import { useBlockchain } from "@/context/BlockchainContext"; import { Card, CardContent, CardDescription, CardHeader, CardTitle, } from "@/components/ui/card";
import { Tabs, TabsContent, TabsList, TabsTrigger } from "@/components/ui/tabs";
import { Button } from "@/components/ui/button";
import { Progress } from "@/components/ui/progress"; import { Clock, Award, BookOpen, User, DollarSign, Calendar as CalendarIcon, UserCog, } from "lucide-react";
import { Badge } from "@/components/ui/badge"; import { BarChart, Bar, XAxis, YAxis, Tooltip, ResponsiveContainer, } from "recharts";
                                ...
                                <div className="flex flex-wrap items-center justify-between gap-4">
                                    ...
                                    <Link to="/profile">
                                        <Button variant="outline" className="flex items-center gap-2">
                                            <UserCog size={16} />
                                            <span>
                                                {user?.name || user?.email ? `Edit profile (${user.name || user.email})` : "Edit profile"}
                                            </span>
                                        </Button>
                                    </Link>
                                </div>
                                                    ...
                                                    <div className="p-6">
                                                        <div className="flex items-center gap-4 mb-4">
                                                            <div className="flex-shrink-0">
                                                                <img src={session.tutorAvatar} alt={session.tutorName} className="w-12 h-12 rounded-full border-2 border-primary/20" />
                                                            </div>
                                                            <div>
                                                ...
                                                <Card key={session.id} className="glass-card overflow-hidden">
                                                    <div className="p-6">
                                                        ...
                                                        <div className="flex items-center gap-1 mb-4">
                                                            <div className="flex">
                                                                {[...Array(5)].map((_, i) => (
                                                                    <span key={i} className={`text-lg ${i < session.rating ? "text-amber-500" : "text-gray-300"}`}>
                                                                        ★
                                                                    </span>
                                                                ))}
                                                            </div>
