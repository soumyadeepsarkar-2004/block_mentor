...
const pressReleases = [
  {
    id: "pr1",
    title:
      "Blockchain Tutor Launches Industry-First AI-Driven Learning Platform",
    date: "2023-11-15",
    summary:
  ...
  },
  {
    id: "pr2",
    title:
      "Blockchain Tutor Secures $5M in Seed Funding to Revolutionize Education",
    date: "2023-09-22",
    summary:
  ...
  },
  {
    id: "pr3",
    title:
      "Blockchain Tutor Partners with Leading Crypto Projects for Education Initiative",
    date: "2023-08-10",
    summary:
  ...
  {
    id: "pr4",
    title: "Blockchain Tutor Announces New Decentralized Certification Program",
    date: "2023-06-15",
    summary:
...
const mediaCoverage = [
  {
    source: "TechCrunch",
    title: "How Blockchain Tutor is Disrupting Traditional Education",
    date: "2023-12-05",
    image:
  ...
  {
    source: "CoinDesk",
    title: "Blockchain Tutor: Bringing Decentralized Learning to the Masses",
    date: "2023-10-18",
    image:
...
const brandAssets = [
  {
    ...
    description:
      "Official Blockchain Tutor logos in various formats and variations",
    link: "#",
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="glass-card p-8 md:p-10">
              <p className="text-lg md:text-xl leading-relaxed mb-6">
                Welcome to the Blockchain Tutor press room. Find the latest
                news, media coverage, press releases, and resources about our
        ...
        >
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="max-w-2xl mx-auto text-tutor-neutral-dark">
                Recent media mentions and coverage of Blockchain Tutor from
                around the world.
              </p>
            </div>
        ...
        <section className="py-20 px-6">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="max-w-2xl mx-auto text-tutor-neutral-dark">
                Download official Blockchain Tutor logos, brand guidelines, and
                media resources.
              </p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
            ...
            <Card className="glass-card mb-16">
              <CardContent className="p-8 text-center">
                ...
                <p className="text-tutor-neutral-dark mb-6">
                  ...
                  information about Blockchain Tutor, please contact our media
                  relations team.
                </p>
